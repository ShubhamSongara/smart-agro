...
[![Live Demo](https://img.shields.io/badge/Live_Demo-Vercel-success?style=flat-square&logo=vercel)](https://smart-agro-kappa.vercel.app/)
...
🌐 **Live Application:** [https://smart-agro-kappa.vercel.app/](https://smart-agro-kappa.vercel.app/)
...
1. **Clone the repository:**
   ```sh
   git clone https://github.com/ShubhamSongara/smart-agro.git
   cd smart-agro
   ```
